  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path='mybooking' element={<MyBooking userSignIn={userSignIn} setUserSignIn={setUserSignIn} />}/>
        ...
        <Route path='detail' element={<DetailProperty userSignIn={userSignIn} setUserSignIn={setUserSignIn} />}/>
